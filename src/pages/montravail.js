  ...
  return (
    <div id="mywork" style={{ width: "80%", marginLeft: "10%" }}>
      ...
      <p style={{ marginLeft: "10%", fontSize: "30px" }}>
        {" "}
        I have worked on dozens of projects so I have picked only the latest for
        you{" "}
      </p>
...
text du description trop grand + color
evitez de recopier le code card et le mettre dans un composant avec des props;
evitez l'utilisation style inline " style={{}} "
le survol (hover) se fait sur 2 card au même temps
